...
<body style="background-color:#232C31">
<div id="homepage">
<img src="4.png">
</div>

<div id="index">
<a href="home.php"><h2 style="float:right; color:#999; margin-left:40px;">Home</h2></a>
<div class="login">
<font face="Ebrima" size="+1" color="#CCCCCC">

<table bordercolordark="#333333" cellpadding="20px;" border="1px;" width="540px;">
<tr><td>Days</td>
<td>I Year</td>
<td>II Year</td>
<td>III Year</td>
